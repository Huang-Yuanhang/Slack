...
function underscorestheme_setup() {
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'underscorestheme' ),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'underscorestheme_custom_background_args',
			array(
...
function underscorestheme_scripts() {
	wp_enqueue_style( 'underscorestheme-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'underscorestheme-style', 'rtl', 'replace' );

	wp_enqueue_script( 'underscorestheme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
